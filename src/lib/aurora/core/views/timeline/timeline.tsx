import { Card, CardAction, CardContent, CardDescription, CardHeader, CardTitle } from '@/lib/shared/components/ui/card';
...
export default function Timeline(props: TimelineProps) {
  const formattedSlug = props.slug.replace(/-/g, ' ').split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
