...
export function createInMemoryThreadRepository(): IThreadsRepository {
    ...
    return {
        ...
        async update(threadId: string, updatedThread: PlotThreadUpdate) {
        ...
        async bulkUpdate(updates: { id: string; data: PlotThreadUpdate }[]) {
