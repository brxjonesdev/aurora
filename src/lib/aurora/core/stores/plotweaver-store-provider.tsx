...
import { type PlotweaverStore, createPlotweaverStore } from '@/lib/aurora/core/stores/plotweaver-store'

export type PlotweaverStoreApi = ReturnType<typeof createPlotweaverStore>

export const PlotweaverStoreContext = createContext<PlotweaverStoreApi | undefined>(
  undefined,
)
...
export const PlotweaverStoreProvider = ({
  children,
}: PlotweaverStoreProviderProps) => {
...
export const usePlotweaverStore = <T,>(
  selector: (store: PlotweaverStore) => T,
): T => {
