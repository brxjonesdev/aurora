...
import { profileService } from "@/lib/aurora/core"
...
export default function CreateProfile({
  ...
  return (
    <Card className="mx-auto w-full max-w-2xl border-2 h-fit">
      <CardHeader>
      ...
      <CardContent className="flex flex-col gap-6 lg:flex-row">
        {/* Avatar */}
        <div className="flex flex-col items-center gap-4 min-w-1/4 justify-center">
          <Avatar
            name={avatarId}
